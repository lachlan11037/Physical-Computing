...
<dd>Windows is a group of several graphical operating system families that allows any other software to be run on the operating system as long as it's supported by windows. It is a renowned example of an operating system.<dd>
...
<dd>Microsoft Word or MS-WORD (often called Word) is a graphical word processing program that users can type with. It is made by the computer company Microsoft. Its purpose is to allow users to type and save documents. Similar to other word processors, it has helpful tools to make documents. It is a renowed example of a computer software.<dd>

# The difference between analog and digital signals:
The difference between analog and digital is that analog signals are a continuous signal which represents physical measurements while digital signals are discrete time signals generated by digital modulation.

# Fantasy Device 
<dt>Chosen Fantasy Device: Implanted Mindreading Chip<dt>
